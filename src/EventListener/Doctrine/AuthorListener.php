...
class AuthorListener
{
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $abbreviation)
    {
        ...
        if (null !== $reflection && $reflection->implementsInterface('Manuxi\SuluAbbreviationsBundle\Entity\Interfaces\AuthorInterface')) {
    ...
    public function onFlush(OnFlushEventArgs $abbreviation)
    {
